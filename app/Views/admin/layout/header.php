...
<head>
  ...
  <link
    rel="icon"
    href="<?= base_url(); ?>template/assets/img/kaiadmin/favicon.png"
    type="image/x-icon" />
  <!-- Fonts and icons -->
  ...
  <link rel="stylesheet" href="<?= base_url(); ?>template/assets/font/fontawesomenew" />
  <link rel="stylesheet" href="<?= base_url(); ?>template/assets/css/kaiadmin.min.css" />
  <link rel="stylesheet" href="<?= base_url(); ?>template/assets/css/login.css" />
